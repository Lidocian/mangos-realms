...
{
	echo "Running $1..."
	mysql -uroot -p1 mangostwo_world < $1
}

function run_characters_sql
{
	echo "Running $1..."
	mysql -uroot -p1 mangostwo_characters < $1
	mysql -uroot -p1 mangostwo_characters_19 < $1
	mysql -uroot -p1 mangostwo_characters_60 < $1
	mysql -uroot -p1 mangostwo_characters_70 < $1
}

function run_realm_sql
{
	echo "Running $1..."
	mysql -uroot -p1 mangostwo_realm < $1
}

function run_sd2_sql
{
	echo "Running $1..."
	mysql -uroot -p1 mangostwo_scripts < $1
}
...
run_world_sql 12364_01_mangos_spell_script_target.sql
run_world_sql 12370_01_mangos_npc_vendor.sql
run_world_sql 12370_02_mangos_npc_vendor_template.sql
run_world_sql 12405_01_mangos_spell_template.sql
